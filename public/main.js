...
function checkUser(){
    ...
    if(user != null){
        ...
        content[0].style.display = 'inline';
        content[1].style.display = 'inline';
        textInput.focus();
    } 
}
...
socket.on('list-update-recon', (data) => {
...
socket.on('show-msg', (data) => {
    addStorageItem(data.username, data.message);
